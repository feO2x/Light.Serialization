...
namespace Light.Serialization.Json.ObjectMetadata
{
    ...
    public interface IMetadataParser
    {
        ...
        /// </summary>
        /// <param name="firstLabelToken">The JSON token that represents the first label in a complex JSON object.</param>
        ...
        MetadataParseResult ParseMetadataSection(ref JsonToken firstLabelToken, JsonDeserializationContext context);
    }
}
...
{
    /// <summary>
    ///     Represents a generic Primitive Type Formatter that can be used for all types where the JSON string
    ///     can be created by calling <c>object.ToString</c> and surrounding the result with quotation marks.
    /// </summary>
    ...
    {
        /// <summary>
        ///     Creates a new instance of ToStringWithQuotationMarksFormatter of T.
        /// </summary>
        ...
        /// <summary>
        ///     Serializes the specified .NET value to a JSON string by calling <c>object.ToString</c> on it and surrounding the resulting string with quotation marks.
        /// </summary>

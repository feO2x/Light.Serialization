...
{
    /// <summary>
    ///     Represents a generic <see cref="IPrimitiveTypeFormatter" /> that can be used for all types where the JSON value can be created by calling <c>object.ToString</c>.
    /// </summary>

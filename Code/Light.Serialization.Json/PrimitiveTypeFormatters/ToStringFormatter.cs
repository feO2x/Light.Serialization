...
{
    /// <summary>
    ///     Represents a generic Primitive Type Formatter that can be used for all types where the JSON value can be created by calling <c>object.ToString</c>.
    /// </summary>
    ...
    {
        /// <summary>
        ///     Creates a new instance of ToStringFormatter of T.
        /// </summary>
        ...
        /// <summary>
        ///     Serializes the specified .NET value by calling <c>object.ToString</c> on it.
        /// </summary>
